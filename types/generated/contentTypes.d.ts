...
export interface ApiReturnsPolicyReturnsPolicy extends Schema.CollectionType {
  collectionName: 'returns_policies';
  info: {
    singularName: 'returns-policy';
    pluralName: 'returns-policies';
    displayName: 'ReturnsPolicy';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::returns-policy.returns-policy',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::returns-policy.returns-policy': ApiReturnsPolicyReturnsPolicy;
